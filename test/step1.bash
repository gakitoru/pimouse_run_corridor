...
mv /tmp/$$-deb /etc/apt/sources.list.d/ros-latest.list

set +vx
while ! apt-get install -y curl ; do
...
apt-get install -y ros-${ROS_VER}-ros-base

ls /etc/ros/rosdep/sources.list.d/20-default.list && rm /etc/ros/rosdep/sources.list.d/20-default.list
rosdep init 
rosdep update
